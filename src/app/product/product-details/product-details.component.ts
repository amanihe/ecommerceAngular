...
export class ProductDetailsComponent implements OnInit {
  ...
  modifier() {
    ...
    this.service
      .updateProduct2(this.product[0].Prod_Id, val)
  ...
  imagecolor(c: any, id: any) {
    ...
    console.log(id);
    this.service.getProductImgColor(id).subscribe((data: any) => {
      this.listImg = data;
    ...
    this.route.params.forEach((params: Params) => {
      if (params['id'] !== undefined) {
        ...
        this.service.getcaracProduct(id).subscribe((data: any) => {
          ...
          for (let l of this.listcaracP) {
            this.service.getcaracDetail(l.Carec_Id).subscribe((data: any) => {
              ...
              this.service
                .getcarac(this.listcaracD[i][0].Carac_Id)
                .subscribe((data: any) => {
        ...
        this.service.getProductById(id).subscribe((data: any) => {
          ...
          this.service.getProductImgById(id).subscribe((data: any) => {
            ...
            this.service.getProductImgColor(this.ID).subscribe((data: any) => {
              this.listImg = data;
